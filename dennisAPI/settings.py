"""
Django settings for dennisAPI project.
...
WSGI_APPLICATION = 'dennisAPI.wsgi.application'
...
# # Channels
ASGI_APPLICATION = 'dennisAPI.asgi.application'
